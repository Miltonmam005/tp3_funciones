...
function gestionarCiudades() {
  ...
  if (ciudades.length > 0) {
    document.writeln(
      "<p><strong>Longitud del arreglo:</strong> " + ciudades.length + "</p>"
    );

    document.writeln("<p><strong>Posiciones específicas:</strong></p>");
    document.writeln("<ul>");
    document.writeln(
      "<li>Primera posición: " + (ciudades[0] || "No existe") + "</li>"
    );
    document.writeln(
      "<li>Tercera posición: " + (ciudades[2] || "No existe") + "</li>"
    );
    document.writeln(
    ...
    if (ciudades.length >= 2) {
      document.writeln(
        "<p><strong>Segunda posición (original):</strong> " +
          ciudades[1] +
          "</p>"
      );
      ciudades[1] = "Barcelona";
      document.writeln(
        "<p><strong>Segunda posición (modificada):</strong> " +
          ciudades[1] +
          "</p>"
      );
    }
